...
The surface temperature of the sun is approximately 6000K. What is the characteristic wavelength of the sun expressed in meters?
...
# variable
T <- 5778 # temperature (K)
lambda <- 2897 * 10^(-3) / T # (m)
print(lambda)
```

```{r wavelengthSun-check}
grade_result(
  pass_if(~identical(round(.result,5), round(0.0005013846,5)))
)
```
